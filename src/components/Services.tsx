      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-400 max-w-xl mx-auto">
            Betrabet ile spor bahislerinden casino oyunlarina, pokerden canli mac izlemeye kadar her sey tek bir platformda.
          </p>
        </div>
